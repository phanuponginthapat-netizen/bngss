...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.students DROP CONSTRAINT IF EXISTS students_classroom_fk';
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.attendance DROP CONSTRAINT IF EXISTS attendance_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.attendance
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.face_scan_logs DROP CONSTRAINT IF EXISTS face_scan_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.behavior_records DROP CONSTRAINT IF EXISTS behavior_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.behavior_records
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.enrollments DROP CONSTRAINT IF EXISTS enroll_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.enrollments
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.health_records DROP CONSTRAINT IF EXISTS health_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.health_records
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.home_visits DROP CONSTRAINT IF EXISTS visit_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.home_visits
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.homeroom_records DROP CONSTRAINT IF EXISTS homeroom_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.parent_student_links DROP CONSTRAINT IF EXISTS parent_link_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.parent_student_links
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.early_childhood_dev DROP CONSTRAINT IF EXISTS ec_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.early_childhood_dev
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.homework_assignments DROP CONSTRAINT IF EXISTS hw_subject_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.eform_recipients DROP CONSTRAINT IF EXISTS eform_rcpt_eform_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.eform_attachments DROP CONSTRAINT IF EXISTS eform_att_eform_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.eform_attachments
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.eforms DROP CONSTRAINT IF EXISTS eform_sender_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.eforms
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.document_recipients DROP CONSTRAINT IF EXISTS doc_rcpt_doc_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.personnel DROP CONSTRAINT IF EXISTS personnel_user_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.personnel
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.pa_agreements DROP CONSTRAINT IF EXISTS pa_personnel_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.pa_indicator_scores DROP CONSTRAINT IF EXISTS pa_score_agreement_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.salary_records DROP CONSTRAINT IF EXISTS salary_personnel_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.salary_records
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.id_plan_records DROP CONSTRAINT IF EXISTS idplan_personnel_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.personnel_assessments DROP CONSTRAINT IF EXISTS pers_assess_user_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.personnel_assessments
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.asset_damage_reports DROP CONSTRAINT IF EXISTS damage_asset_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.asset_damage_reports
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.ict_loans DROP CONSTRAINT IF EXISTS loan_device_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.iot_readings DROP CONSTRAINT IF EXISTS iot_read_device_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.iot_readings
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.garbage_deposits DROP CONSTRAINT IF EXISTS gd_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.garbage_deposits
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.garbage_student_points DROP CONSTRAINT IF EXISTS gsp_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.garbage_student_points
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.garbage_personnel_points DROP CONSTRAINT IF EXISTS gpp_personnel_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.garbage_personnel_points
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.garbage_redemptions DROP CONSTRAINT IF EXISTS gr_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.garbage_redemptions
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.garbage_user_badges DROP CONSTRAINT IF EXISTS gub_student_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.garbage_user_badges
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.notifications DROP CONSTRAINT IF EXISTS notif_user_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.inbox_items DROP CONSTRAINT IF EXISTS inbox_user_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.push_subscriptions DROP CONSTRAINT IF EXISTS push_user_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.pdpa_consents DROP CONSTRAINT IF EXISTS pdpa_user_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.pdpa_consents
...
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.user_dashboard_widgets DROP CONSTRAINT IF EXISTS dashw_user_fk';
EXCEPTION WHEN undefined_table OR undefined_column OR undefined_function OR undefined_object OR undefined_parameter OR invalid_text_representation OR duplicate_object OR duplicate_table THEN
  RAISE NOTICE 'skipped: %', SQLERRM;
END
$guard$;
DO $guard$
BEGIN
  EXECUTE 'ALTER TABLE public.user_dashboard_widgets
...
DO $idxguard$
BEGIN
  EXECUTE 'CREATE UNIQUE INDEX IF NOT EXISTS uniq_attendance_per_day_subject
