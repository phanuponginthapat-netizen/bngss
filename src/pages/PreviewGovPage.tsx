...
export default function PreviewGovPage(){
  return (
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      <h1 className="text-2xl font-bold">Preview ฟอร์มราชการ — BNGSS</h1>
      <p className="text-sm text-muted-foreground">ดูตัวอย่าง Export SchoolMIS + พิมพ์ ปพ.5 / อาหารกลางวัน / โฮมรูม (ข้อมูลตัวอย่าง)</p>

      <Card>
        <CardHeader><CardTitle>1. เกรด — SchoolMIS Excel + ปพ.5</CardTitle></CardHeader>
        <CardContent className="space-y-3">
          ...
          <div className="flex gap-2">
            <Button onClick={()=> exportSchoolMisExcel(sampleRows)}>Export SchoolMIS .xlsx</Button>
            <Button variant="outline" onClick={()=> printPor5(sampleRows, { schoolName:"โรงเรียนบ้านหนองเงือก", term:"1", year:"2568", subjectCode:"ค21101", subjectName:"คณิตศาสตร์1"})}>พิมพ์ ปพ.5</Button>
          </div>
        </CardContent>
      </Card>

      <Card>
        <CardHeader><CardTitle>2. อาหารกลางวัน — รายงาน สพฐ.</CardTitle></CardHeader>
        <CardContent className="space-y-3">
      ...
      <Card>
        <CardHeader><CardTitle>3. โฮมรูม 5 หมวด — สพฐ. ระบบดูแลช่วยเหลือนักเรียน</CardTitle></CardHeader>
        <CardContent className="space-y-3">
