...
DROP POLICY IF EXISTS "Staff can view home visit photos" ON storage.objects;
DROP POLICY IF EXISTS "Staff can view home visit photos" ON storage.objects;
...
DROP POLICY IF EXISTS "Staff can delete home visit photos" ON storage.objects;
DROP POLICY IF EXISTS "Staff can delete home visit photos" ON storage.objects;
...
DROP POLICY IF EXISTS "Staff and owner view PA files" ON storage.objects;
DROP POLICY IF EXISTS "Staff and owner view PA files" ON storage.objects;
...
DROP POLICY IF EXISTS "Staff update PA files" ON storage.objects;
DROP POLICY IF EXISTS "Staff update PA files" ON storage.objects;
CREATE POLICY "Staff update PA files" ON storage.objects FOR UPDATE TO authenticated
USING (bucket_id='pa-files' AND (public.has_role(auth.uid(),'admin') OR public.has_role(auth.uid(),'director') OR (storage.foldername(name))[1] = auth.uid()::text));
DROP POLICY IF EXISTS "Admin delete PA files" ON storage.objects;
DROP POLICY IF EXISTS "Admin delete PA files" ON storage.objects;
...
DROP POLICY IF EXISTS "Staff view pp6 files" ON storage.objects;
DROP POLICY IF EXISTS "Staff view pp6 files" ON storage.objects;
...
DROP POLICY IF EXISTS "Admin delete pp6 files" ON storage.objects;
DROP POLICY IF EXISTS "Admin delete pp6 files" ON storage.objects;
...
DROP POLICY IF EXISTS "Staff manage student_screenings" ON public.student_screenings;
DROP POLICY IF EXISTS "Staff manage student_screenings" ON public.student_screenings;
...
DROP POLICY IF EXISTS "Staff manage vaccine_records" ON public.vaccine_records;
DROP POLICY IF EXISTS "Staff manage vaccine_records" ON public.vaccine_records;
CREATE POLICY "Staff manage vaccine_records" ON public.vaccine_records FOR ALL TO authenticated
USING (public.has_role(auth.uid(),'admin') OR public.has_role(auth.uid(),'director') OR public.has_role(auth.uid(),'teacher'))
WITH CHECK (public.has_role(auth.uid(),'admin') OR public.has_role(auth.uid(),'director') OR public.has_role(auth.uid(),'teacher'));
DROP POLICY IF EXISTS "Students view own vaccines" ON public.vaccine_records;
DROP POLICY IF EXISTS "Students view own vaccines" ON public.vaccine_records;
...
DROP POLICY IF EXISTS "Personnel manage own time_clock" ON public.time_clock;
DROP POLICY IF EXISTS "Personnel manage own time_clock" ON public.time_clock;
...
DROP POLICY IF EXISTS "Students manage own time_clock" ON public.time_clock;
DROP POLICY IF EXISTS "Students manage own time_clock" ON public.time_clock;
...
DROP POLICY IF EXISTS "Staff manage all time_clock" ON public.time_clock;
DROP POLICY IF EXISTS "Staff manage all time_clock" ON public.time_clock;
...
DROP POLICY IF EXISTS "Staff manage teacher_assignments" ON public.teacher_assignments;
DROP POLICY IF EXISTS "Staff manage teacher_assignments" ON public.teacher_assignments;
...
DROP POLICY IF EXISTS "Staff manage subject_indicators" ON public.subject_indicators;
DROP POLICY IF EXISTS "Staff manage subject_indicators" ON public.subject_indicators;
...
DROP POLICY IF EXISTS "Staff manage substitute_teaching" ON public.substitute_teaching;
DROP POLICY IF EXISTS "Staff manage substitute_teaching" ON public.substitute_teaching;
