...
export function getEmbedUrl(link: Pick<SocialLink, "platform" | "url">): string | null {
  ...
  try {
    ...
    if (link.platform === "facebook") {
      ...
      return `https://www.facebook.com/plugins/page.php?href=${href}&tabs=timeline&width=500&height=520&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true`;
