      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground whitespace-pre-line">
            {lang === "th"
              ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            สาเหตุ: {\"error\":\"return_url required\",\"received\":\"https://bngss.vercel.app/dashboard/my-drive?tab=settings\",\"hint\":\"must be http(s) and localhost or the APP_URL / ALLOWED_RETURN_ORIGINS origin\"}\n\nคำแนะนำ: ลองใหม่อีกครั้ง หากยังไม่ได้ให้รีเฟรชหน้า หรือแจ้งผู้ดูแลระบบพร้อมภาพหน้าจอ"
              : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            สาเหตุ: {\"error\":\"return_url required\",\"received\":\"https://bngss.vercel.app/dashboard/my-drive?tab=settings\",\"hint\":\"must be http(s) and localhost or the APP_URL / ALLOWED_RETURN_ORIGINS origin\"}\n\nคำแนะนำ: ลองใหม่อีกครั้ง หากยังไม่ได้ให้รีเฟรชหน้า หรือแจ้งผู้ดูแลระบบพร้อมภาพหน้าจอ"}
          </p>
        </div>
      </div>
