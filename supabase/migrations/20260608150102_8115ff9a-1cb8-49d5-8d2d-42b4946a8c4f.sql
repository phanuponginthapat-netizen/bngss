...
DROP TRIGGER IF EXISTS trg_portfolio_updated ON public.update_updated_at_column;
...
DROP TRIGGER IF EXISTS trg_wall_posts_updated ON public.update_updated_at_column;
...
DROP TRIGGER IF EXISTS trg_wall_comments_updated ON public.update_updated_at_column;
...
BEGIN
  ...
  RETURN NULL;
END $$;
DROP TRIGGER IF EXISTS trg_react_count ON public.wall_post_counters;
...
DROP TRIGGER IF EXISTS trg_comm_count ON public.wall_post_counters;
...
BEGIN
  ...
  RETURN NEW;
END $$;
DROP TRIGGER IF EXISTS trg_fill_wall_school ON public.fill_wall_school;
...
BEGIN
  ...
  RETURN NEW;
END $$;
DROP TRIGGER IF EXISTS trg_fill_portfolio_school ON public.fill_portfolio_school;
