...
const ObservationAccessPage = lazy(() => import("./pages/admin/ObservationAccessPage"));
          ...
          <ErrorBoundary>
            <Suspense fallback={<SystemLoader />}>
              ...
              <Route path="/dashboard" element={<DashboardLayout />}>
                ...
                <Route path="hub/wellbeing" element={<ProtectedRoute allowedRoles={["admin","director","teacher","student","parent"]}><WellbeingHubPage /></ProtectedRoute>} />
                ...
                {/* ลงทะเบียนใบหน้าของตนเอง — ทุกบัญชีที่ล็อกอินเข้าถึงได้ (ข้อมูลของตัวเองเท่านั้น) */}
                <Route path="student/my-face" element={<ProtectedRoute><MyFaceEnrollPage /></ProtectedRoute>} />
