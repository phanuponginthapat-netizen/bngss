...
CREATE INDEX IF NOT EXISTS idx_gchat_logs_created ON public.google_chat_logs(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_gchat_logs_type ON public.google_chat_logs(notification_type);
...
BEGIN
  ...
  RETURN NEW;
END $$;
DROP TRIGGER IF EXISTS trg_gchat_news ON public.news_posts;
CREATE TRIGGER trg_gchat_news AFTER INSERT OR UPDATE ON public.news_posts
...
BEGIN
  ...
  RETURN NEW;
END $$;
DROP TRIGGER IF EXISTS trg_gchat_emergency ON public.emergency_broadcasts;
CREATE TRIGGER trg_gchat_emergency AFTER INSERT ON public.emergency_broadcasts
...
BEGIN
  ...
  RETURN NEW;
END $$;
DROP TRIGGER IF EXISTS trg_gchat_document ON public.documents;
CREATE TRIGGER trg_gchat_document AFTER INSERT ON public.documents
...
BEGIN
  ...
  RETURN NEW;
END $$;
DROP TRIGGER IF EXISTS trg_gchat_staff_leave ON public.staff_leaves;
CREATE TRIGGER trg_gchat_staff_leave AFTER INSERT OR UPDATE ON public.staff_leaves
...
BEGIN
  ...
  RETURN NEW;
END $$;
DROP TRIGGER IF EXISTS trg_gchat_substitute ON public.substitute_teaching;
CREATE TRIGGER trg_gchat_substitute AFTER INSERT OR UPDATE ON public.substitute_teaching
...
BEGIN
  ...
  RETURN NEW;
END $$;
DROP TRIGGER IF EXISTS trg_gchat_behavior ON public.behavior_records;
CREATE TRIGGER trg_gchat_behavior AFTER INSERT ON public.behavior_records
