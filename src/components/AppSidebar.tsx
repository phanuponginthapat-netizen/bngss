...
export function AppSidebar() {
  ...
  const mainItems: MenuItem[] = [
    ...
    { title: L("ลงทะเบียนใบหน้าบุคลากร", "Staff Face Enrollment"), url: "/dashboard/student/face-scan?tab=staff", icon: ScanFace, color: "text-indigo-400", roles: ["admin", "director", "teacher"], desc: L("ลงทะเบียนใบหน้าครูและบุคลากรเพื่อทดสอบ/สแกนเข้าโรงเรียน", "Enroll staff faces for test/check-in") },
  ...
  const departments: Department[] = [
    {
      ...
      items: [
        ...
        { title: L("ออกแบบต้นแบบบัตรประจำตัว", "ID Card Template"), url: "/dashboard/admin/id-card", icon: IdCard, color: "text-fuchsia-400", roles: ["admin", "director"], desc: L("ตั้งค่าธีม โลโก้ QR และพิมพ์บัตร", "Design theme, logo, QR & print cards") },
    ...
    },
    {
      ...
      items: [
        ...
        { title: L("สถานะตู้ Kiosk หน้าประตู", "Door Kiosk Health"), url: "/dashboard/admin/kiosk-health", icon: DoorOpen, color: "text-emerald-400", roles: ["admin"], desc: L("เช็ค online/offline และความปกติของตู้สแกนหน้าประตู", "Door kiosk online/offline & health") },
        { title: L("รายงาน Smart Gate", "Smart Gate Report"), url: "/dashboard/admin/smart-gate", icon: DoorOpen, color: "text-amber-400", roles: ["admin"], desc: L("ไข้สูง วัตถุต้องสงสัย และอุณหภูมิจากจุดคัดกรอง", "Fever, weapon & temperature screening") },
