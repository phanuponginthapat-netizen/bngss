...
const sheetVariants = cva(
  // เพิ่ม overflow-y-auto + safe-area padding เพื่อให้ Sheet ทุกด้านเลื่อนเห็นเนื้อหาครบ ไม่ถูก URL bar / home bar บัง
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out overflow-y-auto overscroll-contain data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 [&]:pb-[calc(env(safe-area-inset-bottom)+1.5rem)]",
  {
    variants: {
      side: {
