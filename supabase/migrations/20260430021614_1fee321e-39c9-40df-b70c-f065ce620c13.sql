...
DROP TRIGGER IF EXISTS trg_auto_link_student ON public.profiles;
CREATE TRIGGER trg_auto_link_student
...
-- ============================================
DROP TRIGGER IF EXISTS trg_auto_substitute_on_leave ON public.staff_leaves;
CREATE TRIGGER trg_auto_substitute_on_leave
...
DROP TRIGGER IF EXISTS trg_notify_eform_recipient ON public.eform_recipients;
CREATE TRIGGER trg_notify_eform_recipient
AFTER INSERT ON public.eform_recipients
FOR EACH ROW EXECUTE FUNCTION public.notify_on_eform_recipient();

DROP TRIGGER IF EXISTS trg_notify_eform_action ON public.eform_recipients;
CREATE TRIGGER trg_notify_eform_action
AFTER UPDATE ON public.eform_recipients
FOR EACH ROW EXECUTE FUNCTION public.notify_sender_on_recipient_action();

DROP TRIGGER IF EXISTS trg_recompute_eform_status ON public.eform_recipients;
CREATE TRIGGER trg_recompute_eform_status
AFTER UPDATE ON public.eform_recipients
...
CREATE TRIGGER trg_notify_doc_reply
AFTER UPDATE ON public.document_recipients
FOR EACH ROW EXECUTE FUNCTION public.notify_sender_on_document_reply();

DROP TRIGGER IF EXISTS trg_notify_doc_created ON public.documents;
CREATE TRIGGER trg_notify_doc_created
AFTER INSERT ON public.documents
FOR EACH ROW EXECUTE FUNCTION public.notify_on_document_created();

DROP TRIGGER IF EXISTS trg_notify_staff_leave ON public.staff_leaves;
CREATE TRIGGER trg_notify_staff_leave
AFTER INSERT ON public.staff_leaves
FOR EACH ROW EXECUTE FUNCTION public.notify_on_staff_leave();

DROP TRIGGER IF EXISTS trg_notify_student_leave ON public.student_leaves;
CREATE TRIGGER trg_notify_student_leave
AFTER INSERT ON public.student_leaves
FOR EACH ROW EXECUTE FUNCTION public.notify_on_student_leave();

DROP TRIGGER IF EXISTS trg_notify_negative_behavior ON public.behavior_records;
CREATE TRIGGER trg_notify_negative_behavior
...
CREATE TRIGGER trg_sync_notif_to_inbox
...
DROP TRIGGER IF EXISTS trg_auto_deduct_budget ON public.procurement_records;
CREATE TRIGGER trg_auto_deduct_budget
